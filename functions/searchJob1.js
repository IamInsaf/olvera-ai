...
exports.searchJob = functions.https.onRequest(async (req, res) => {
  ...
  try {
    ...
    if (req.body.intermediateAnalysis && req.body.questions && req.body.answers) {
      const analysis = await performIntermediateAnalysis(dreamJob, userProfileData, req.body.questions, req.body.answers);
...
// Perform intermediate analysis after first 5 questions
